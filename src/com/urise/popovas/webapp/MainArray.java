...
import com.urise.popovas.webapp.storage.FileStorage;
...
public class MainArray {
    private final static AbstractStorage STORAGE = new FileStorage(new ObjectSerializer(), new File("D:\\ResumeArchive"));
